...
export function useCharacter(
  ...
  async function updateCharacter(
    updates: Partial<
      Pick<Character, 'name' | 'race' | 'class' | 'level' | 'primary_casting_class' | 'current_hp' | 'max_hp' | 'temp_hp' | 'armor_class' | 'death_save_successes' | 'death_save_failures' | 'conditions' | 'skill_proficiencies' | 'proficiencies' | 'languages' | 'gold' | 'initiative_modifier' | 'passive_perception' | 'proficiency_bonus' | 'spell_attack_bonus' | 'spell_save_dc' | 'skill_overrides' | 'hit_dice_remaining' | 'inspiration' | 'speed' | 'swim_speed' | 'fly_speed' | 'climb_speed' | 'burrow_speed' | 'concentration_spell_id' | 'alignment' | 'backstory' | 'personality_traits' | 'ideals' | 'bonds' | 'flaws' | 'wild_shape_active' | 'wild_shape_beast_name' | 'wild_shape_current_hp' | 'wild_shape_max_hp' | 'wild_shape_beast_ac' | 'wild_shape_beast_str' | 'wild_shape_beast_dex' | 'wild_shape_beast_con' | 'wild_shape_beast_speed' | 'wild_shape_beast_swim_speed' | 'wild_shape_beast_fly_speed' | 'wild_shape_beast_climb_speed' | 'wild_shape_beast_burrow_speed' | 'image_url' | 'image_position' | 'theme'>
    >,
  ) {
